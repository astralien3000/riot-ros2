...
#ifndef BUILTIN_INTERFACES__MSG__TIME__TYPE_SUPPORT_H_
#define BUILTIN_INTERFACES__MSG__TIME__TYPE_SUPPORT_H_
...
#endif  // BUILTIN_INTERFACES__MSG__TIME__TYPE_SUPPORT_H_
