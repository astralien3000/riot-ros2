...
#include "std_msgs/msg/dds_opensplice/float64_multi_array__type_support.hpp"
...
using __ros_msg_type = std_msgs::msg::Float64MultiArray;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_msgs
const char *
register_type__Float64MultiArray(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, std_msgs, msg, Float64MultiArray)() {
  return &std_msgs::msg::typesupport_opensplice_cpp::handle;
}
