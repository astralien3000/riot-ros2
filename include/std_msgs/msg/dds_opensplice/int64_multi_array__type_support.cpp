...
#include "std_msgs/msg/dds_opensplice/int64_multi_array__type_support.hpp"
...
using __ros_msg_type = std_msgs::msg::Int64MultiArray;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_msgs
const char *
register_type__Int64MultiArray(
