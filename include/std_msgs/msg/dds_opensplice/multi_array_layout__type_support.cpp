...
#include "std_msgs/msg/dds_opensplice/multi_array_layout__type_support.hpp"
...
void convert_ros_message_to_dds(
  const std_msgs::msg::MultiArrayDimension &,
  std_msgs::msg::dds_::MultiArrayDimension_ &);
void convert_dds_message_to_ros(
  const std_msgs::msg::dds_::MultiArrayDimension_ &,
...
using __ros_msg_type = std_msgs::msg::MultiArrayLayout;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_msgs
const char *
register_type__MultiArrayLayout(
  ...
  // field.name dim
  {
    ...
    for (DDS::ULong i = 0; i < size; i++) {
      std_msgs::msg::typesupport_opensplice_cpp::convert_ros_message_to_dds(
        ros_message.dim[i], dds_message.dim_[i]);
    }
  }
  ...
  // field.name dim
  {
    ...
    for (DDS::ULong i = 0; i < size; i++) {
      std_msgs::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
        dds_message.dim_[i], ros_message.dim[i]);
    }
  }
  // field.name data_offset
  ros_message.data_offset =
    dds_message.data_offset_;
}

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_msgs
const char *
take__MultiArrayLayout(
