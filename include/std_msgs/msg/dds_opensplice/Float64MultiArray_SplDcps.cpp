...
const char *
__std_msgs_msg_dds__Float64MultiArray___name(void)
{
    return (const char*)"std_msgs::msg::dds_::Float64MultiArray_";
}

const char *
__std_msgs_msg_dds__Float64MultiArray___keys(void)
{
    return (const char*)"";
}
...
/* Code generated by /private/tmp/opensplice-20170321-33051-1xv1o2s/opensplice/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 774 */
        ...
        c_long length0;
        c_double *dest0;
        ::std_msgs::msg::dds_::Float64MultiArray_::_data__seq *src = &from->data_;
...
__std_msgs_msg_dds__Float64MultiArray___copyOut(
    ...
    void *_to)
{
    struct _std_msgs_msg_dds__Float64MultiArray_ *from = (struct _std_msgs_msg_dds__Float64MultiArray_ *)_from;
    struct ::std_msgs::msg::dds_::Float64MultiArray_ *to = (struct ::std_msgs::msg::dds_::Float64MultiArray_ *)_to;
    {
    ...
    {
        long size0;
        c_double *src0 = (c_double *)from->data_;
        ::std_msgs::msg::dds_::Float64MultiArray_::_data__seq *dst = &to->data_;
