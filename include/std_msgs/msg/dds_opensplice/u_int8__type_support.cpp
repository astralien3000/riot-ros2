...
#include "std_msgs/msg/dds_opensplice/u_int8__type_support.hpp"
...
using __dds_msg_type = std_msgs::msg::dds_::UInt8_;
using __ros_msg_type = std_msgs::msg::UInt8;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_msgs
const char *
register_type__UInt8(
  ...
  const char * type_name)
{
  ...
  std_msgs::msg::dds_::UInt8_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::UInt8_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::UInt8_TypeSupport.register_type: unknown return code";
  }
}
  ...
  const void * untyped_ros_message)
{
  ...
  std_msgs::msg::dds_::UInt8_DataWriter * data_writer =
    std_msgs::msg::dds_::UInt8_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: "
             "this std_msgs::msg::dds_::UInt8_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: "
             "this std_msgs::msg::dds_::UInt8_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: "
             "the handle has not been registered with this std_msgs::msg::dds_::UInt8_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::UInt8_DataWriter.write: unknown return code";
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  std_msgs::msg::dds_::UInt8_DataReader * data_reader =
    std_msgs::msg::dds_::UInt8_DataReader::_narrow(topic_reader);

  std_msgs::msg::dds_::UInt8_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "std_msgs::msg::dds_::UInt8_DataReader.take: "
        "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "std_msgs::msg::dds_::UInt8_DataReader.take: "
        "this std_msgs::msg::dds_::UInt8_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "std_msgs::msg::dds_::UInt8_DataReader.take: "
        "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "std_msgs::msg::dds_::UInt8_DataReader.take: "
        "this std_msgs::msg::dds_::UInt8_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "std_msgs::msg::dds_::UInt8_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "std_msgs::msg::dds_::UInt8_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::UInt8_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "std_msgs::msg::dds_::UInt8_DataReader.return_loan: "
             "this std_msgs::msg::dds_::UInt8_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "std_msgs::msg::dds_::UInt8_DataReader.return_loan: "
             ...
             "std_msgs::msg::dds_::UInt8_DataReader";
    case DDS::RETCODE_OK:
      break;
    default:
      return "std_msgs::msg::dds_::UInt8_DataReader.return_loan failed with "
             "unknown return code";
  }
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, std_msgs, msg, UInt8)() {
  return &std_msgs::msg::typesupport_opensplice_cpp::handle;
}
