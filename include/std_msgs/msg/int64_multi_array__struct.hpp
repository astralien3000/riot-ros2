...
#ifndef STD_MSGS__MSG__INT64_MULTI_ARRAY__STRUCT_HPP_
#define STD_MSGS__MSG__INT64_MULTI_ARRAY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_std_msgs_msg_Int64MultiArray __attribute__((deprecated))
#else
# define DEPRECATED_std_msgs_msg_Int64MultiArray __declspec(deprecated)
#endif
...
struct Int64MultiArray_
{
  ...
  explicit Int64MultiArray_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_std_msgs_msg_Int64MultiArray
    std::shared_ptr<std_msgs::msg::Int64MultiArray_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_std_msgs_msg_Int64MultiArray
    std::shared_ptr<std_msgs::msg::Int64MultiArray_<ContainerAllocator> const>
...
#endif  // STD_MSGS__MSG__INT64_MULTI_ARRAY__STRUCT_HPP_
