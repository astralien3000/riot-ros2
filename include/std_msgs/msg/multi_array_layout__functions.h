...
#ifndef STD_MSGS__MSG__MULTI_ARRAY_LAYOUT__FUNCTIONS_H_
#define STD_MSGS__MSG__MULTI_ARRAY_LAYOUT__FUNCTIONS_H_
...
#endif  // STD_MSGS__MSG__MULTI_ARRAY_LAYOUT__FUNCTIONS_H_
