...
#include "std_msgs/msg/multi_array_dimension__functions.h"  // dim

// forward declare type support functions
const rosidl_message_type_support_t *
  ROSIDL_GET_TYPE_SUPPORT_FUNCTION(std_msgs, msg, MultiArrayDimension)();  // dim

using __dds_msg_type = std_msgs::msg::dds_::MultiArrayLayout_;
using __ros_msg_type = std_msgs__msg__MultiArrayLayout;
...
register_type(void * untyped_participant, const char * type_name)
{
  ...
  std_msgs::msg::dds_::MultiArrayLayout_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::MultiArrayLayout_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::MultiArrayLayout_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  // Field name: dim
  {
    const message_type_support_callbacks_t * std_msgs__msg__MultiArrayDimension__callbacks =
    ...
    dds_message->dim_.length(length);
    for (DDS::ULong i = 0; i < size; ++i) {
      auto & ros_i = ros_message->dim.data[i];
      const char * err_msg = std_msgs__msg__MultiArrayDimension__callbacks->convert_ros_to_dds(
        &ros_i, &dds_message->dim_[i]);
      if (err_msg != 0) {
        return err_msg;
      }
    }
  ...
  {
    dds_message->data_offset_ = ros_message->data_offset;
  }
...
publish(void * dds_data_writer, const void * ros_message)
{
  ...
  std_msgs::msg::dds_::MultiArrayLayout_DataWriter * data_writer =
    std_msgs::msg::dds_::MultiArrayLayout_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: "
             "this std_msgs::msg::dds_::MultiArrayLayout_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: "
             "this std_msgs::msg::dds_::MultiArrayLayout_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: "
             "the handle has not been registered with this std_msgs::msg::dds_::MultiArrayLayout_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataWriter.write: unknown return code";
  }
}
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: dim
  {
    size_t size = dds_message->dim_.length();
    if (ros_message->dim.data) {
      std_msgs__msg__MultiArrayDimension__Array__fini(&ros_message->dim);
    }
    if (!std_msgs__msg__MultiArrayDimension__Array__init(&ros_message->dim, size)) {
      return "failed to create array for field 'dim'";
    }
    for (DDS::ULong i = 0; i < size; i++) {
      auto & ros_i = ros_message->dim.data[i];
      const rosidl_message_type_support_t * ts =
        ROSIDL_GET_TYPE_SUPPORT_FUNCTION(std_msgs, msg, MultiArrayDimension)();
      const message_type_support_callbacks_t * callbacks =
        static_cast<const message_type_support_callbacks_t *>(ts->data);
      callbacks->convert_dds_to_ros(&dds_message->dim_[i], &ros_i);
    }
  }

  // Field name: data_offset
  {
    ros_message->data_offset = dds_message->data_offset_;
  }
  ...
  void * sending_publication_handle)
{
  ...
  std_msgs::msg::dds_::MultiArrayLayout_DataReader * data_reader =
    std_msgs::msg::dds_::MultiArrayLayout_DataReader::_narrow(topic_reader);

  std_msgs::msg::dds_::MultiArrayLayout_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "std_msgs::msg::dds_::MultiArrayLayout_DataReader.take: "
        "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "std_msgs::msg::dds_::MultiArrayLayout_DataReader.take: "
        "this std_msgs::msg::dds_::MultiArrayLayout_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "std_msgs::msg::dds_::MultiArrayLayout_DataReader.take: "
        "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "std_msgs::msg::dds_::MultiArrayLayout_DataReader.take: "
        "this std_msgs::msg::dds_::MultiArrayLayout_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "std_msgs::msg::dds_::MultiArrayLayout_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "std_msgs::msg::dds_::MultiArrayLayout_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataReader.return_loan: "
             "this std_msgs::msg::dds_::MultiArrayLayout_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataReader.return_loan: "
             ...
             "std_msgs::msg::dds_::MultiArrayLayout_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::MultiArrayLayout_DataReader.return_loan failed with "
             "unknown return code";
  }
