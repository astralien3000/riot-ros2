...
const char *
__std_msgs_msg_dds__UInt32MultiArray___name(void)
{
    return (const char*)"std_msgs::msg::dds_::UInt32MultiArray_";
}

const char *
__std_msgs_msg_dds__UInt32MultiArray___keys(void)
{
    return (const char*)"";
}
...
/* Code generated by /private/tmp/opensplice-20170321-33051-1xv1o2s/opensplice/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 774 */
        ...
        c_long length0;
        c_ulong *dest0;
        ::std_msgs::msg::dds_::UInt32MultiArray_::_data__seq *src = &from->data_;

        if (type0 == NULL) {
            subtype0 = c_type(c_metaResolve (c_metaObject(base), "c_ulong"));
            type0 = c_metaSequenceTypeNew(c_metaObject(base),"C_SEQUENCE<c_ulong>",subtype0,0);
            c_free(subtype0);
        }
        length0 = (c_long)(*src).length();
#ifdef OSPL_BOUNDS_CHECK
         dest0 = (c_ulong *)c_newSequence(c_collectionType(type0),length0);
        {
...
__std_msgs_msg_dds__UInt32MultiArray___copyOut(
    ...
    void *_to)
{
    struct _std_msgs_msg_dds__UInt32MultiArray_ *from = (struct _std_msgs_msg_dds__UInt32MultiArray_ *)_from;
    struct ::std_msgs::msg::dds_::UInt32MultiArray_ *to = (struct ::std_msgs::msg::dds_::UInt32MultiArray_ *)_to;
    {
    ...
    {
        long size0;
        c_ulong *src0 = (c_ulong *)from->data_;
        ::std_msgs::msg::dds_::UInt32MultiArray_::_data__seq *dst = &to->data_;
