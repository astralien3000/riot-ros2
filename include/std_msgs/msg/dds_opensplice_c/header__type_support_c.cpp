...
ROSIDL_GENERATOR_C_IMPORT_std_msgs
const rosidl_message_type_support_t *
  ROSIDL_GET_TYPE_SUPPORT_FUNCTION(builtin_interfaces, msg, Time)();  // stamp

using __dds_msg_type = std_msgs::msg::dds_::Header_;
using __ros_msg_type = std_msgs__msg__Header;
...
convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  // Field name: frame_id
  {
    ...
    dds_message->frame_id_ = DDS::string_dup(str->data);
  }
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: frame_id
  {
    ...
    if (!succeeded) {
      return "failed to assign string into field 'frame_id'";
    }
  }
...
const rosidl_message_type_support_t *
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(std_msgs, msg, Header)() {
