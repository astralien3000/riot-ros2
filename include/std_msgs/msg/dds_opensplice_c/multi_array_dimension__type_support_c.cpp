...
using __ros_msg_type = std_msgs__msg__MultiArrayDimension;
...
convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  // Field name: label
  {
    ...
    dds_message->label_ = DDS::string_dup(str->data);
  }
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: label
  {
    ...
    bool succeeded = rosidl_generator_c__String__assign(
      ...
      dds_message->label_);
    if (!succeeded) {
      return "failed to assign string into field 'label'";
    }
  }
  ...
  // Field name: stride
  {
    ros_message->stride = dds_message->stride_;
  }
...
static message_type_support_callbacks_t __callbacks = {
  ...
  "MultiArrayDimension",  // message_name
