...
#include "std_msgs/msg/int64_multi_array__functions.h"
...
using __dds_msg_type = std_msgs::msg::dds_::Int64MultiArray_;
using __ros_msg_type = std_msgs__msg__Int64MultiArray;
...
register_type(void * untyped_participant, const char * type_name)
{
  ...
  std_msgs::msg::dds_::Int64MultiArray_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::Int64MultiArray_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::Int64MultiArray_TypeSupport.register_type: unknown return code";
  }
}
...
publish(void * dds_data_writer, const void * ros_message)
{
  ...
  std_msgs::msg::dds_::Int64MultiArray_DataWriter * data_writer =
    std_msgs::msg::dds_::Int64MultiArray_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: "
             "this std_msgs::msg::dds_::Int64MultiArray_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: "
             "this std_msgs::msg::dds_::Int64MultiArray_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: "
             "the handle has not been registered with this std_msgs::msg::dds_::Int64MultiArray_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::Int64MultiArray_DataWriter.write: unknown return code";
  }
}
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__int64__Array__fini(&ros_message->data);
    }
    if (!rosidl_generator_c__int64__Array__init(&ros_message->data, size)) {
  ...
  void * sending_publication_handle)
{
  ...
  std_msgs::msg::dds_::Int64MultiArray_DataReader * data_reader =
    std_msgs::msg::dds_::Int64MultiArray_DataReader::_narrow(topic_reader);

  std_msgs::msg::dds_::Int64MultiArray_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "std_msgs::msg::dds_::Int64MultiArray_DataReader.take: "
        "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "std_msgs::msg::dds_::Int64MultiArray_DataReader.take: "
        "this std_msgs::msg::dds_::Int64MultiArray_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "std_msgs::msg::dds_::Int64MultiArray_DataReader.take: "
        "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "std_msgs::msg::dds_::Int64MultiArray_DataReader.take: "
        "this std_msgs::msg::dds_::Int64MultiArray_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "std_msgs::msg::dds_::Int64MultiArray_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "std_msgs::msg::dds_::Int64MultiArray_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "std_msgs::msg::dds_::Int64MultiArray_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "std_msgs::msg::dds_::Int64MultiArray_DataReader.return_loan: "
             "this std_msgs::msg::dds_::Int64MultiArray_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "std_msgs::msg::dds_::Int64MultiArray_DataReader.return_loan: "
             ...
             "std_msgs::msg::dds_::Int64MultiArray_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "std_msgs::msg::dds_::Int64MultiArray_DataReader.return_loan failed with "
             "unknown return code";
  }
...
const rosidl_message_type_support_t *
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(std_msgs, msg, Int64MultiArray)() {
