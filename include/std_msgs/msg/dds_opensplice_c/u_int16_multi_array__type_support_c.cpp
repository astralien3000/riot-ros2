...
using __ros_msg_type = std_msgs__msg__UInt16MultiArray;
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_generator_c__uint16__Array__fini(&ros_message->data);
    }
    if (!rosidl_generator_c__uint16__Array__init(&ros_message->data, size)) {
