...
#ifndef STD_MSGS__MSG__STRING__FUNCTIONS_H_
#define STD_MSGS__MSG__STRING__FUNCTIONS_H_
...
ROSIDL_GENERATOR_C_PUBLIC_std_msgs
bool
std_msgs__msg__String__Array__init(std_msgs__msg__String__Array * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_std_msgs
void
std_msgs__msg__String__Array__fini(std_msgs__msg__String__Array * array);
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_std_msgs
std_msgs__msg__String__Array *
std_msgs__msg__String__Array__create(size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_std_msgs
void
std_msgs__msg__String__Array__destroy(std_msgs__msg__String__Array * array);

#if __cplusplus
}
#endif

#endif  // STD_MSGS__MSG__STRING__FUNCTIONS_H_
