...
#ifndef RCL_INTERFACES__MSG__PARAMETER__TYPE_SUPPORT_H_
#define RCL_INTERFACES__MSG__PARAMETER__TYPE_SUPPORT_H_
...
#endif  // RCL_INTERFACES__MSG__PARAMETER__TYPE_SUPPORT_H_
