...
#include "rosidl_generator_c/string.h"  // reason
#include "rosidl_generator_c/string_functions.h"  // reason

// forward declare type support functions

using __dds_msg_type = rcl_interfaces::msg::dds_::SetParametersResult_;
using __ros_msg_type = rcl_interfaces__msg__SetParametersResult;
...
convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  // Field name: reason
  {
    const rosidl_generator_c__String * str = &ros_message->reason;
    if (!str) {
    ...
    dds_message->reason_ = DDS::string_dup(str->data);
  }
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: successful
  {
    ros_message->successful = dds_message->successful_ == TRUE;
  }

  // Field name: reason
  {
    if (!ros_message->reason.data) {
      rosidl_generator_c__String__init(&ros_message->reason);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->reason,
      dds_message->reason_);
    if (!succeeded) {
      return "failed to assign string into field 'reason'";
    }
  }
...
static message_type_support_callbacks_t __callbacks = {
  ...
  "SetParametersResult",  // message_name
