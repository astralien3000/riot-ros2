...
#include "rcl_interfaces/msg/dds_opensplice/ccpp_Parameter_.h"
...
#include "rcl_interfaces/msg/parameter_value__functions.h"  // value
#include "rosidl_generator_c/string.h"  // name
#include "rosidl_generator_c/string_functions.h"  // name

// forward declare type support functions
const rosidl_message_type_support_t *
  ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, msg, ParameterValue)();  // value

using __dds_msg_type = rcl_interfaces::msg::dds_::Parameter_;
using __ros_msg_type = rcl_interfaces__msg__Parameter;
...
register_type(void * untyped_participant, const char * type_name)
{
  ...
  rcl_interfaces::msg::dds_::Parameter_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "rcl_interfaces::msg::dds_::Parameter_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "rcl_interfaces::msg::dds_::Parameter_TypeSupport.register_type: unknown return code";
  }
}
...
convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  // Field name: value
  {
    ...
    const char * err_msg = rcl_interfaces__msg__ParameterValue__callbacks->convert_ros_to_dds(
...
publish(void * dds_data_writer, const void * ros_message)
{
  ...
  rcl_interfaces::msg::dds_::Parameter_DataWriter * data_writer =
    rcl_interfaces::msg::dds_::Parameter_DataWriter::_narrow(topic_writer);
  DDS::ReturnCode_t status = data_writer->write(dds_message, DDS::HANDLE_NIL);
  // This causes the DDS::String_mgr to release the given c string without freeing it.
  dds_message.name_._retn();
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: "
             "this rcl_interfaces::msg::dds_::Parameter_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: "
             "this rcl_interfaces::msg::dds_::Parameter_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: "
             "the handle has not been registered with this rcl_interfaces::msg::dds_::Parameter_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "rcl_interfaces::msg::dds_::Parameter_DataWriter.write: unknown return code";
  }
}
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: value
  {
    const rosidl_message_type_support_t * ts =
      ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, msg, ParameterValue)();
  ...
  void * sending_publication_handle)
{
  ...
  rcl_interfaces::msg::dds_::Parameter_DataReader * data_reader =
    rcl_interfaces::msg::dds_::Parameter_DataReader::_narrow(topic_reader);

  rcl_interfaces::msg::dds_::Parameter_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "rcl_interfaces::msg::dds_::Parameter_DataReader.take: "
        "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "rcl_interfaces::msg::dds_::Parameter_DataReader.take: "
        "this rcl_interfaces::msg::dds_::Parameter_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "rcl_interfaces::msg::dds_::Parameter_DataReader.take: "
        "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "rcl_interfaces::msg::dds_::Parameter_DataReader.take: "
        "this rcl_interfaces::msg::dds_::Parameter_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "rcl_interfaces::msg::dds_::Parameter_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "rcl_interfaces::msg::dds_::Parameter_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "rcl_interfaces::msg::dds_::Parameter_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "rcl_interfaces::msg::dds_::Parameter_DataReader.return_loan: "
             "this rcl_interfaces::msg::dds_::Parameter_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "rcl_interfaces::msg::dds_::Parameter_DataReader.return_loan: "
             ...
             "rcl_interfaces::msg::dds_::Parameter_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "rcl_interfaces::msg::dds_::Parameter_DataReader.return_loan failed with "
             "unknown return code";
  }
