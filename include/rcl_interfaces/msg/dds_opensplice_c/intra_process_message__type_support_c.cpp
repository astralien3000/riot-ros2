...
using __ros_msg_type = rcl_interfaces__msg__IntraProcessMessage;
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: publisher_id
  {
    ros_message->publisher_id = dds_message->publisher_id_;
  }

  // Field name: message_sequence
  {
    ros_message->message_sequence = dds_message->message_sequence_;
  }
...
static message_type_support_callbacks_t __callbacks = {
  ...
  "IntraProcessMessage",  // message_name
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, msg, IntraProcessMessage)() {
