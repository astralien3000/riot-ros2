...
#include "rcl_interfaces/msg/dds_opensplice/parameter__type_support.hpp"
...
using __ros_msg_type = rcl_interfaces::msg::Parameter;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
register_type__Parameter(
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  ...
  rcl_interfaces::msg::typesupport_opensplice_cpp::convert_dds_message_to_ros(
    dds_message.value_, ros_message.value);
}
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, rcl_interfaces, msg, Parameter)() {
  return &rcl_interfaces::msg::typesupport_opensplice_cpp::handle;
}
