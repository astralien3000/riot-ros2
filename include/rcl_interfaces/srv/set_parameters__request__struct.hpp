...
#ifndef RCL_INTERFACES__SRV__SET_PARAMETERS__REQUEST__STRUCT_HPP_
#define RCL_INTERFACES__SRV__SET_PARAMETERS__REQUEST__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_rcl_interfaces_srv_SetParameters_Request __attribute__((deprecated))
#else
# define DEPRECATED_rcl_interfaces_srv_SetParameters_Request __declspec(deprecated)
#endif
...
struct SetParameters_Request_
{
  ...
  explicit SetParameters_Request_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_rcl_interfaces_srv_SetParameters_Request
    std::shared_ptr<rcl_interfaces::srv::SetParameters_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_rcl_interfaces_srv_SetParameters_Request
    std::shared_ptr<rcl_interfaces::srv::SetParameters_Request_<ContainerAllocator> const>
...
#endif  // RCL_INTERFACES__SRV__SET_PARAMETERS__REQUEST__STRUCT_HPP_
