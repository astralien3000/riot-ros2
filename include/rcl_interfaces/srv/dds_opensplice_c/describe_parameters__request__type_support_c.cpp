...
using __dds_msg_type = rcl_interfaces::srv::dds_::DescribeParameters_Request_;
using __ros_msg_type = rcl_interfaces__srv__DescribeParameters_Request;
...
register_type(void * untyped_participant, const char * type_name)
{
  ...
  rcl_interfaces::srv::dds_::DescribeParameters_Request_TypeSupport type_support;
  DDS::ReturnCode_t status = type_support.register_type(participant, type_name);
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_TypeSupport.register_type: "
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_TypeSupport.register_type: unknown return code";
  }
}
...
publish(void * dds_data_writer, const void * ros_message)
{
  ...
  rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter * data_writer =
    rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter::_narrow(topic_writer);
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: "
             "an internal error has occurred";
    case DDS::RETCODE_BAD_PARAMETER:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: "
    ...
    case DDS::RETCODE_ALREADY_DELETED:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: "
             "this rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter has already been deleted";
    case DDS::RETCODE_OUT_OF_RESOURCES:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: "
             "out of resources";
    case DDS::RETCODE_NOT_ENABLED:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: "
             "this rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter is not enabled";
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: "
             "the handle has not been registered with this rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter";
    ...
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataWriter.write: unknown return code";
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader * data_reader =
    rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader::_narrow(topic_reader);

  rcl_interfaces::srv::dds_::DescribeParameters_Request_Seq dds_messages;
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      errs = "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.take: "
        "an internal error has occurred";
      goto finally;
    case DDS::RETCODE_ALREADY_DELETED:
      errs = "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.take: "
        "this rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader has already been deleted";
      goto finally;
    case DDS::RETCODE_OUT_OF_RESOURCES:
      errs = "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.take: "
        "out of resources";
    ...
    case DDS::RETCODE_NOT_ENABLED:
      errs = "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.take: "
        "this rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader is not enabled";
      goto finally;
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      errs = "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.take: "
    ...
    case DDS::RETCODE_OK:
      break;
    default:
      errs = "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.take: unknown return code";
      goto finally;
  }
  ...
  switch (status) {
    case DDS::RETCODE_ERROR:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.return_loan: "
             "an internal error has occurred";
    case DDS::RETCODE_ALREADY_DELETED:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.return_loan: "
             "this rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader has already been deleted";
    ...
    case DDS::RETCODE_PRECONDITION_NOT_MET:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.return_loan: "
             ...
             "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader";
    case DDS::RETCODE_OK:
      return nullptr;
    default:
      return "rcl_interfaces::srv::dds_::DescribeParameters_Request_DataReader.return_loan failed with "
             "unknown return code";
  }
...
static message_type_support_callbacks_t __callbacks = {
  ...
  "DescribeParameters_Request",  // message_name
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, srv, DescribeParameters_Request)() {
