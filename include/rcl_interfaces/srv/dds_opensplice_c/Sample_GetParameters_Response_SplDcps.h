...
extern const char * __rcl_interfaces_srv_dds__Sample_GetParameters_Response___keys (void);
extern const char * __rcl_interfaces_srv_dds__Sample_GetParameters_Response___name (void);
struct _rcl_interfaces_srv_dds__Sample_GetParameters_Response_ ;
extern  c_bool __rcl_interfaces_srv_dds__Sample_GetParameters_Response___copyIn(c_base base, struct rcl_interfaces::srv::dds_::Sample_GetParameters_Response_ *from, struct _rcl_interfaces_srv_dds__Sample_GetParameters_Response_ *to);
extern  void __rcl_interfaces_srv_dds__Sample_GetParameters_Response___copyOut(void *_from, void *_to);
struct _rcl_interfaces_srv_dds__Sample_GetParameters_Response_ {
