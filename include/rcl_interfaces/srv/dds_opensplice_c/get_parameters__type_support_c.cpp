...
#include "rcl_interfaces/srv/dds_opensplice/get_parameters__type_support.cpp"
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::register_types__GetParameters(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::create_requester__GetParameters(
...
create_responder__GetParameters(
  ...
  void * (*allocator)(size_t))
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::create_responder__GetParameters(
    untyped_participant, service_name,
  ...
  void * untyped_requester, const void * untyped_ros_request, int64_t * sequence_number)
{
  ...
  const rosidl_message_type_support_t * ts =
    ROSIDL_GET_TYPE_SUPPORT(rcl_interfaces, srv, GetParameters_Request);
  ...
  const void * untyped_ros_response)
{
  ...
  const rosidl_message_type_support_t * ts =
    ROSIDL_GET_TYPE_SUPPORT(rcl_interfaces, srv, GetParameters_Response);
  const message_type_support_callbacks_t * callbacks =
    static_cast<const message_type_support_callbacks_t *>(ts->data);
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::destroy_requester__GetParameters(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::destroy_responder__GetParameters(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::server_is_available__GetParameters(
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, srv, GetParameters)() {
