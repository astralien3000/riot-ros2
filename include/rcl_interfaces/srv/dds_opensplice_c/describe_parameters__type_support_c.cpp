...
#include "rcl_interfaces/srv/dds_opensplice/describe_parameters__type_support.cpp"
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::register_types__DescribeParameters(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::create_requester__DescribeParameters(
...
create_responder__DescribeParameters(
  ...
  void * (*allocator)(size_t))
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::create_responder__DescribeParameters(
    untyped_participant, service_name,
  ...
  void * untyped_requester, const void * untyped_ros_request, int64_t * sequence_number)
{
  ...
  const rosidl_message_type_support_t * ts =
    ROSIDL_GET_TYPE_SUPPORT(rcl_interfaces, srv, DescribeParameters_Request);
  ...
  const void * untyped_ros_response)
{
  ...
  const rosidl_message_type_support_t * ts =
    ROSIDL_GET_TYPE_SUPPORT(rcl_interfaces, srv, DescribeParameters_Response);
  const message_type_support_callbacks_t * callbacks =
    static_cast<const message_type_support_callbacks_t *>(ts->data);
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::destroy_requester__DescribeParameters(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::destroy_responder__DescribeParameters(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::server_is_available__DescribeParameters(
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, srv, DescribeParameters)() {
