...
#include "rcl_interfaces/msg/parameter_value__functions.h"  // values

// forward declare type support functions
const rosidl_message_type_support_t *
  ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, msg, ParameterValue)();  // values

using __dds_msg_type = rcl_interfaces::srv::dds_::GetParameters_Response_;
using __ros_msg_type = rcl_interfaces__srv__GetParameters_Response;
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: values
  {
    ...
    if (ros_message->values.data) {
      rcl_interfaces__msg__ParameterValue__Array__fini(&ros_message->values);
    }
    if (!rcl_interfaces__msg__ParameterValue__Array__init(&ros_message->values, size)) {
    ...
    for (DDS::ULong i = 0; i < size; i++) {
      ...
      callbacks->convert_dds_to_ros(&dds_message->values_[i], &ros_i);
    }
  }
...
static message_type_support_callbacks_t __callbacks = {
  ...
  "GetParameters_Response",  // message_name
...
const rosidl_message_type_support_t *
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, srv, GetParameters_Response)() {
