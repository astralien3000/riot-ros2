...
#include "rcl_interfaces/srv/dds_opensplice/get_parameter_types__type_support.cpp"
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::register_types__GetParameterTypes(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::create_requester__GetParameterTypes(
...
create_responder__GetParameterTypes(
  ...
  void * (*allocator)(size_t))
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::create_responder__GetParameterTypes(
    untyped_participant, service_name,
  ...
  void * untyped_requester, const void * untyped_ros_request, int64_t * sequence_number)
{
  ...
  const rosidl_message_type_support_t * ts =
    ROSIDL_GET_TYPE_SUPPORT(rcl_interfaces, srv, GetParameterTypes_Request);
  ...
  const void * untyped_ros_response)
{
  ...
  const rosidl_message_type_support_t * ts =
    ROSIDL_GET_TYPE_SUPPORT(rcl_interfaces, srv, GetParameterTypes_Response);
  const message_type_support_callbacks_t * callbacks =
    static_cast<const message_type_support_callbacks_t *>(ts->data);
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::destroy_requester__GetParameterTypes(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::destroy_responder__GetParameterTypes(
...
{
  return rcl_interfaces::srv::typesupport_opensplice_cpp::server_is_available__GetParameterTypes(
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(rcl_interfaces, srv, GetParameterTypes)() {
