...
using __ros_msg_type = rcl_interfaces::srv::SetParameters_Request;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
register_type__SetParameters_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
publish__SetParameters_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, rcl_interfaces, srv, SetParameters_Request)() {
  return &rcl_interfaces::srv::typesupport_opensplice_cpp::handle;
}
