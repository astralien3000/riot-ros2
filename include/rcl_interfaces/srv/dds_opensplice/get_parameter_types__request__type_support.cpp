...
using __ros_msg_type = rcl_interfaces::srv::GetParameterTypes_Request;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
register_type__GetParameterTypes_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
publish__GetParameterTypes_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_rcl_interfaces
const char *
take__GetParameterTypes_Request(
