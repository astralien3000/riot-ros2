...
#ifndef RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__REQUEST__STRUCT_HPP_
#define RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__REQUEST__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_rcl_interfaces_srv_DescribeParameters_Request __attribute__((deprecated))
#else
# define DEPRECATED_rcl_interfaces_srv_DescribeParameters_Request __declspec(deprecated)
#endif
...
struct DescribeParameters_Request_
{
  ...
  explicit DescribeParameters_Request_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_rcl_interfaces_srv_DescribeParameters_Request
    std::shared_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_rcl_interfaces_srv_DescribeParameters_Request
    std::shared_ptr<rcl_interfaces::srv::DescribeParameters_Request_<ContainerAllocator> const>
...
#endif  // RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__REQUEST__STRUCT_HPP_
