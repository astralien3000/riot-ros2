...
#ifndef RCL_INTERFACES__MSG__PARAMETER_EVENT__STRUCT_HPP_
#define RCL_INTERFACES__MSG__PARAMETER_EVENT__STRUCT_HPP_
...
#else
# define DEPRECATED_rcl_interfaces_msg_ParameterEvent __declspec(deprecated)
#endif
...
struct ParameterEvent_
{
  ...
  explicit ParameterEvent_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_rcl_interfaces_msg_ParameterEvent
    std::shared_ptr<rcl_interfaces::msg::ParameterEvent_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_rcl_interfaces_msg_ParameterEvent
    std::shared_ptr<rcl_interfaces::msg::ParameterEvent_<ContainerAllocator> const>
...
#endif  // RCL_INTERFACES__MSG__PARAMETER_EVENT__STRUCT_HPP_
