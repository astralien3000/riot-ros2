...
#ifndef BUILTIN_INTERFACES__MSG__TIME__STRUCT_HPP_
#define BUILTIN_INTERFACES__MSG__TIME__STRUCT_HPP_
...
struct Time_
{
  ...
  explicit Time_(const ContainerAllocator & _alloc)
...
#endif  // BUILTIN_INTERFACES__MSG__TIME__STRUCT_HPP_
