...
#ifndef STD_MSGS__MSG__U_INT32_MULTI_ARRAY__STRUCT_HPP_
#define STD_MSGS__MSG__U_INT32_MULTI_ARRAY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_std_msgs_msg_UInt32MultiArray __attribute__((deprecated))
#else
# define DEPRECATED_std_msgs_msg_UInt32MultiArray __declspec(deprecated)
#endif
...
struct UInt32MultiArray_
{
  ...
  explicit UInt32MultiArray_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_std_msgs_msg_UInt32MultiArray
    std::shared_ptr<std_msgs::msg::UInt32MultiArray_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_std_msgs_msg_UInt32MultiArray
    std::shared_ptr<std_msgs::msg::UInt32MultiArray_<ContainerAllocator> const>
...
#endif  // STD_MSGS__MSG__U_INT32_MULTI_ARRAY__STRUCT_HPP_
