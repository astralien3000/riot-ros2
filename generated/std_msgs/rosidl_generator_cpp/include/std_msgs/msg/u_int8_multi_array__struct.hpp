...
#ifndef STD_MSGS__MSG__U_INT8_MULTI_ARRAY__STRUCT_HPP_
#define STD_MSGS__MSG__U_INT8_MULTI_ARRAY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_std_msgs_msg_UInt8MultiArray __attribute__((deprecated))
#else
# define DEPRECATED_std_msgs_msg_UInt8MultiArray __declspec(deprecated)
#endif
...
struct UInt8MultiArray_
{
  ...
  explicit UInt8MultiArray_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_std_msgs_msg_UInt8MultiArray
    std::shared_ptr<std_msgs::msg::UInt8MultiArray_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_std_msgs_msg_UInt8MultiArray
    std::shared_ptr<std_msgs::msg::UInt8MultiArray_<ContainerAllocator> const>
...
#endif  // STD_MSGS__MSG__U_INT8_MULTI_ARRAY__STRUCT_HPP_
