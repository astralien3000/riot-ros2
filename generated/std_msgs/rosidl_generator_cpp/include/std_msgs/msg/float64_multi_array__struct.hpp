...
#ifndef STD_MSGS__MSG__FLOAT64_MULTI_ARRAY__STRUCT_HPP_
#define STD_MSGS__MSG__FLOAT64_MULTI_ARRAY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_std_msgs_msg_Float64MultiArray __attribute__((deprecated))
#else
# define DEPRECATED_std_msgs_msg_Float64MultiArray __declspec(deprecated)
#endif
...
struct Float64MultiArray_
{
  ...
  explicit Float64MultiArray_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_std_msgs_msg_Float64MultiArray
    std::shared_ptr<std_msgs::msg::Float64MultiArray_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_std_msgs_msg_Float64MultiArray
    std::shared_ptr<std_msgs::msg::Float64MultiArray_<ContainerAllocator> const>
...
#endif  // STD_MSGS__MSG__FLOAT64_MULTI_ARRAY__STRUCT_HPP_
