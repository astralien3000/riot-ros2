...
#include <std_msgs/msg/int64_multi_array__introspection_type_support.h>
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(std_msgs, msg, Int64MultiArray)() {
  std_msgs__msg__rosidl_typesupport_introspection_c__Int64MultiArray_message_member_array[0].members_ = ROSIDL_GET_TYPE_SUPPORT(std_msgs, msg, MultiArrayLayout);
