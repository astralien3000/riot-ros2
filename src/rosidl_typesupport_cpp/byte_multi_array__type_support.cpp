...
static const _type_support_ids_t _ByteMultiArray_message_typesupport_ids = {
  {
...
static const _type_support_symbol_names_t _ByteMultiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, std_msgs, msg, ByteMultiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, std_msgs, msg, ByteMultiArray)),
  }
};
...
static _type_support_data_t _ByteMultiArray_message_typesupport_data = {
  {
...
{
  return &::std_msgs::msg::rosidl_typesupport_cpp::ByteMultiArray_message_type_support_handle;
}
