...
static const _type_support_ids_t _GetParameters_service_typesupport_ids = {
  {
...
static const _type_support_symbol_names_t _GetParameters_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcl_interfaces, GetParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, rcl_interfaces, GetParameters)),
  }
};
...
static _type_support_data_t _GetParameters_service_typesupport_data = {
  {
