...
static const _type_support_ids_t _GetParameterTypes_Response_message_typesupport_ids = {
  {
...
static const _type_support_symbol_names_t _GetParameterTypes_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, rcl_interfaces, srv, GetParameterTypes_Response)),
  }
};
...
static _type_support_data_t _GetParameterTypes_Response_message_typesupport_data = {
  {
