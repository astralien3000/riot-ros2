...
static const _type_support_ids_t _ColorRGBA_message_typesupport_ids = {
  {
...
static const _type_support_symbol_names_t _ColorRGBA_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, std_msgs, msg, ColorRGBA)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, std_msgs, msg, ColorRGBA)),
  }
};
...
static _type_support_data_t _ColorRGBA_message_typesupport_data = {
  {
...
{
  return &::std_msgs::msg::rosidl_typesupport_cpp::ColorRGBA_message_type_support_handle;
}
