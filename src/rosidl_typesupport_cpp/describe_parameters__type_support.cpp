...
static const _type_support_ids_t _DescribeParameters_service_typesupport_ids = {
  {
...
static const _type_support_symbol_names_t _DescribeParameters_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcl_interfaces, DescribeParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, rcl_interfaces, DescribeParameters)),
  }
};
...
static _type_support_data_t _DescribeParameters_service_typesupport_data = {
  {
...
{
  return &::rcl_interfaces::srv::rosidl_typesupport_cpp::DescribeParameters_service_type_support_handle;
}
