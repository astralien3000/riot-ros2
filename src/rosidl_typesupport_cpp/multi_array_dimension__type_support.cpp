...
static const _type_support_ids_t _MultiArrayDimension_message_typesupport_ids = {
  {
...
static const _type_support_symbol_names_t _MultiArrayDimension_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, std_msgs, msg, MultiArrayDimension)),
  }
};
...
static _type_support_data_t _MultiArrayDimension_message_typesupport_data = {
  {
